...
// в”Ђв”Ђв”Ђ NEXUS VISION palette (matches the site's neon cyber theme) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
const NX = {
  p:   "#00f5ff",   // primary neon cyan
  s:   "#ff006e",   // secondary neon pink
  a:   "#7fff00",   // accent neon green
  bg:  "rgba(0,245,255,0.06)",
  dim: "rgba(0,245,255,0.35)",
};

// в”Ђв”Ђв”Ђ Corner-bracket + HUD face box renderer в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
function drawFaceBoxNexus(
  ...
  const cl = 24; // corner line length
  ...
  // Animated scan line through face
  ...
  ctx.fillStyle   = NX.p;
  ctx.globalAlpha = 0.6;
  ctx.fillText("FACE LOCKED в—Џ", bx + 2, by + bh + 12);
  ctx.globalAlpha = 1;

  ctx.restore();
}

// в”Ђв”Ђв”Ђ Scanning reticle when no face detected в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
// в”Ђв”Ђв”Ђ HUD tick marks on canvas edges в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
function drawHUD(ctx: CanvasRenderingContext2D, w: number, h: number, fps: number) {
  ...
  ctx.textAlign   = "right";
  ctx.fillText("[ NEXUSВ·VISION ]", w - 8, 14);
  ctx.textAlign   = "left";
  ctx.globalAlpha = 1;
  ctx.restore();
}
...
export const StudentCamera = React.memo(function StudentCamera({
  sessionId,
  onAttentionUpdate,
  isPhoneAllowed,
}: {
  ...
  // в”Ђв”Ђ Snapshot (untouched) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  ...
  // Render loop: draw video and overlays every rAF.
  ...
  // в”Ђв”Ђ MediaPipe results callback в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  const onResults = useCallback((results: any) => {
    ...
    facesRef.current = detections.map(det => {
      ...
      const mirX  = 1 - rawX - bb.width;   // mirror X to match flipped video
      return {
        x:    mirX     * W,
  ...
  // в”Ђв”Ђ Load MediaPipe scripts в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  ...
  // в”Ђв”Ђ Toggle camera (untouched logic, rAF loop added) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  ...
  // в”Ђв”Ђ Status dot colour в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  const getDotClass = () => {
  ...
  return (
    <div className="student-camera-widget rounded-xl overflow-hidden mt-4">
      ...
      {isEnabled ? (
        ...
        >
          {/* Hidden video: canvas renders the mirrored frame */}
          <video
            ref={videoRef}
          ...
          {/* Canvas: renders video + HUD overlays */}
          <canvas
            ref={overlayRef}
            width={640}
            height={480}
          ...
          {/* в”Ђв”Ђ NEXUS HUD: top-left info panel в”Ђв”Ђ */}
          <div
          ...
          >
            ...
            <div style={{ color: "#ff006e", fontSize: 9, letterSpacing: 3, marginBottom: 6 }}>в–ё NEXUSВ·VISION TRACKER</div>
            ...
            {faceStats && (
              <>
                <div style={{ display: "flex", justifyContent: "space-between", gap: 12 }}>
                  <span style={{ color: "rgba(0,245,255,0.55)" }}>X В· Y</span>
                  <span style={{ color: "#7fff00" }}>{faceStats.x} В· {faceStats.y}</span>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between", gap: 12 }}>
                  <span style={{ color: "rgba(0,245,255,0.55)" }}>W В· H</span>
                  <span style={{ color: "#7fff00" }}>{faceStats.w} В· {faceStats.h}</span>
                </div>
              </>
            )}
          </div>

          {/* в”Ђв”Ђ No-face warning в”Ђв”Ђ */}
          {!hasFace && (
            <div
